...
def agnfitter(galaxies, run_ten=False, git_push=False, rX=False, copy=False, model_sub=False, settings=None):
    for g in galaxies:
        lqso = LensedQSO(g)

        if model_sub:
            model_subtraction(lqso)
        run_agn_fitter([g], run_ten=run_ten, rX=rX, settings=settings)
