...
AGN_FITTER_PATH = App.config().get(section='AGNFITTER', option='agnfitter_path')
# AGN_FITTER_RX_PATH = os.path.join(os.pardir, 'AGNfitter-rX_v0.1', '')


def run_agn_fitter(galaxies, rX=False, run_times=1, component='_sub_demag'):
    ...
    for g in galaxies:
        ...
        settings = lqso.agn_fitter_settings(rX=rX)
