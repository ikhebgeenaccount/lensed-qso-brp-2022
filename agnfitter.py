...
def agnfitter(galaxies, run_ten=False, git_push=False, rX=False, copy=False, model_sub=False):
    for g in galaxies:
        lqso = LensedQSO(g)
...
if __name__ == '__main__':
    ...
    agnfitter(gals, run_ten=args.tenmode, git_push=args.push, rX=args.rX, copy=args.copy, model_sub=args.modelsub)
